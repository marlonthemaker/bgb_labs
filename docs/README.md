...
Cross-project documentation is organized by ownership:
...
strategy and method live in [`research/canon/`](../research/canon/README.md).
Mutable delivery status lives only in [`issues/README.md`](../issues/README.md).
