...
MR-0 is the first controlled implementation of this loop.
...
MR-0 should not invent a large benchmark before proving the method.
...
MR-0 primarily targets credible E3 evidence for its controlled scope. It does not by itself support broad market, language, or certification claims.
...
Use 12 carefully designed semantic contracts before expanding to a benchmark.
