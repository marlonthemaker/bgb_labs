...
| HSD6-H-001 | Planned: newest-first history and exact-record retrieval preserve current evidence across empty, missing, malformed, and unavailable states with typed 400/404/503 boundaries. | `hotel_shoreline/src/unit/evidence-ledger/view.unit.test.ts`; `hotel_shoreline/e2e/evidence-experience.spec.ts` |
| HSD6-U-001 | Planned: arm lifecycle presentation distinguishes reached, failed, not-reached, partial/failed, completed, and pair-exclusion states without inventing events. | `hotel_shoreline/src/unit/evidence-experience.unit.test.ts`; `hotel_shoreline/e2e/evidence-experience.spec.ts` |
| HSD6-U-002 | Planned: record-derived comparison inspection preserves source/provenance, matched conditions, evidence, measure definitions/denominators, first-loss, and claim limits. | `hotel_shoreline/src/unit/evidence-experience.unit.test.ts`; `hotel_shoreline/e2e/evidence-experience.spec.ts` |
| HSD6-U-003 | Planned: one deterministic versioned JSON download is projected from immutable evidence and excludes secrets, server/database details, hidden prompts, exceptions, and real personal data. | `hotel_shoreline/src/unit/evidence-experience.unit.test.ts`; `hotel_shoreline/e2e/evidence-experience.spec.ts` |
| HSD6-U-004 | Planned: desktop/390 px keyboard flow, focus, status announcements, overflow, failure states, and disclosures remain usable. | `hotel_shoreline/e2e/evidence-experience.spec.ts` |
